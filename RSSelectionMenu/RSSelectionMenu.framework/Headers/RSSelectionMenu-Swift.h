...
@property (nonatomic, strong) UISearchBar * _Nullable searchBar;
...
@interface RSSelectionMenuSearchDelegate (SWIFT_EXTENSION(RSSelectionMenu)) <UISearchBarDelegate, UIBarPositioningDelegate>
