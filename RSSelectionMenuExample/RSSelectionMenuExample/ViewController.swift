...
class ViewController: UITableViewController {
    ...
    func presentWithMultiSelectionAndSearch() {
        ...
        // title and color
        selectionMenu.setNavigationBar(title: "Select Player", attributes: [NSAttributedStringKey.foregroundColor : UIColor.white], barTintColor: UIColor.orange.withAlphaComponent(0.5))
