...
@interface RSSelectionMenu (SWIFT_EXTENSION(RSSelectionMenu)) <UIPopoverPresentationControllerDelegate>
...
@interface RSSelectionMenuDelegate (SWIFT_EXTENSION(RSSelectionMenu)) <UITableViewDelegate>
